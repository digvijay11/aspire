...
<head>
  ...
  <link rel="stylesheet" href="{{ URL::asset('public/admin/css/nyroModal.css') }}">
  @yield('styles')
  <!--[if lt IE 9]>
  ...
  <script src="{{ URL::asset('public/admin/js/vendor.js') }}"></script>
   ...
   $.ajaxSetup({
    ...
    <body>
                ...
                <aside class="sidebar">
                    <div class="sidebar-container">
                        <div class="sidebar-header">
                            ...
                            {{ config('site.title')  or 'Aspir 2.0' }}  </div>
                            </a>
                        </div>
        ...
        <script src="http://getwebhelp.com/bootpop/js/jquery.bootpop.js"></script> 
