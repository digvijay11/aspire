                            ...
                            <div class="center-block">
                                ...
                                <div class="panel mt40 col-md-7">
                                    <div class="panel-heading">
                                        <span class="panel-title">Tenant(s) </span>
                                    </div>
...
<address>
    ...
    <abbr title="Mobile">Contact :</abbr>123-456-7890 / 123 456-7890 / 123 456-7890
                                ...
                                <div class="panel col-md-5">
                                    <div class="panel-heading">
                                        <span class="panel-title">Search or Add Tenamt's</span>
                                    </div>
                                    <div class="panel-body br-t">
                                        <div class="allcp-form theme-primary">
                                            <div class="section row mb10">
                                                <div class="col-sm-9 ph10">
                                                    <label for="door_no" class="field">
                                                        {!! Form::text('done_by', null, array('id'=>'instuction_date','class' => 'gui-input mb10','placeholder'=>'Type Tenant Name or Email ')) !!}
                                                    </label>  
                                                </div>
  ...
  {!! Form::submit('Add New Tenant',['class'=>'btn btn-save btn-block btn-success']) !!}
